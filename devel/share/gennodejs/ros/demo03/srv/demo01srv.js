...
class demo01srvRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type demo01srvRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type demo01srvRequest
    let len;
    let data = new demo01srvRequest(null);
  ...
  static datatype() {
    ...
    return 'demo03/demo01srvRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new demo01srvRequest(null);
...
class demo01srvResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type demo01srvResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type demo01srvResponse
    let len;
    let data = new demo01srvResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new demo01srvResponse(null);
...
module.exports = {
  Request: demo01srvRequest,
  Response: demo01srvResponse,
  md5sum() { return '4781436a0c2affec8025955a6041e481'; },
  datatype() { return 'demo03/demo01srv'; }
};
